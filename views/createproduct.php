...
<div class="container-lg" style="padding-top: 45px;">
  ...
  <div style=" margin: 0%; padding: 0%;">
    <h2 style="font-size: 45px; margin-bottom: 0%; padding-bottom: 0%;"><b>Create Product</b></h2>
  </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="formulario bg-color5 rounded-3">
                    <h2 class="text-center mb-5" style="font-size: 45px;"><b>Create Product</b></h2>
                    <form action="" method="post" enctype="multipart/form-data">
                      <div class="mb-3 row">
                        ...
                        <div class="col-sm-10 mb-3">
                          <input type="number" class="form-control" id="price" name="price" step="0.01" value="" required>
                        </div>
                      ...
                      <div style="text-align: center;">
                        <input class="btn btn-dark" type="submit" value="Create Product">
                      </div>
                    </form>
                  </div>
                </div> 
