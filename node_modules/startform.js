...
//import { alert, force, confirm, input, select, date, setOptions, hideAlerts } from 'notie';
  ...
  function youReviewd() {
    notie.alert({ type: 'info', text: 'You have already reviewed this order!', time: 4 });
  }
      ...
      if(finalRate != 0){
        ...
        .then(function(response) {
                ...
                .then(function(responseGet) {
                  ...
                  document.getElementById("myForm").style.display = "none";
                  notie.alert({ type: 1, text: 'Order have been Review Succefully!', time: 4 })
                });
        });

      }else{
        notie.alert({ type: 'error', text: 'Plz Rate this order first', time: 4 });
        
      }

    }else{
      notie.alert({ type: 'error', text: 'Plz write some comment first!', time: 4 });
